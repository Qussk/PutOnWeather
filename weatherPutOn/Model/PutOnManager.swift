...
class PutOnManager{
  let putonArray = [PutOn(curr: 0.0, category:
                            [Category(spring: "spring01", summer: "summer01", fall: "fall01", winter: "winter01"),
...
var num = 0
  ...
  func springImage() -> String {
    return putonArray[num].category[num].spring
  }
  func summerImage() -> String {
    return putonArray[num].category[num].summer
  }
  func fallImage() -> String {
    return putonArray[num].category[num].fall
  }
  func winterImage() -> String {
    return putonArray[num].category[num].winter
  }
